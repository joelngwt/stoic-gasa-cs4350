...
public class Stage_Sequence_1_4 : Stage_Sequence_Helper {
	 ...
	 * derived classes
	 * */
	public Stage_Sequence_1_4 (Stage_Sequence_Reader given_squence_reader) 	{
	...
	public override void process_update () 	{
		...
		if(sequence_phase_index == 0)
		{
			 ...
			 * 
			 * Note: 
			 * Wrong numbering. This is a repeat. 
			 * Skip to next
			 * */
			attached_reader.attached_sequence = new Stage_Sequence_1_5(attached_reader);
		}
	}
