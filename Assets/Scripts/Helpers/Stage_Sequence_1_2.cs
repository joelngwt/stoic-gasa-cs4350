...
public class Stage_Sequence_1_2 : Stage_Sequence_Helper {
	 ...
	 * derived classes
	 * */
	public Stage_Sequence_1_2 (Stage_Sequence_Reader given_squence_reader) 	{
	...
	public override void process_update () 	{
		...
		if(sequence_phase_index == 0)
		{
			 ...
			 * Initialize 
			 * */
			spawn_list.Add(spawnBear(new Vector3( -60f, 0f, 246f ), 1)); // target6
			spawn_list.Add(spawnBear(new Vector3( 48f, 0f, 218f ), 1)); // target7
			spawn_list.Add(spawnBear(new Vector3( -16f, 0f, 173f ), 0)); // target8
			spawn_list.Add(spawnBear(new Vector3( 34f, 21f, 154f ), 0)); // target9
			spawn_list.Add(spawnBear(new Vector3( 52f, 21f, 154f ), 0)); // target10
		...
		else if(sequence_phase_index == 2)
		{
			 ...
			 * */
			attached_reader.attached_sequence = new Stage_Sequence_1_3(attached_reader);
		}
	}
